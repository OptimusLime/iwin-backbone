...
// iwin-backbone
#define COCOAPODS_POD_AVAILABLE_iwin_backbone
#define COCOAPODS_VERSION_MAJOR_iwin_backbone 0
#define COCOAPODS_VERSION_MINOR_iwin_backbone 1
#define COCOAPODS_VERSION_PATCH_iwin_backbone 0
